...
public class CarroServices {
	 // Inyección de la dependencia de la clase de negocio
	@Inject
	...
	public Response crear(Carro carro) {
		// Se guarda el carro usando el método de la lógica de negocio
		try{
	...
	public Response actualizar(Carro carro) {
		 // Se actualiza el carro usando el método de la lógica de negocio
		try{
	...
	public String borrar(@QueryParam("placa") String placa) {
		// Se elimina el carro usando el método de la lógica de negocio
		try{
	...
	public Response leer(@QueryParam("placa") String placa, @QueryParam("modelo") String modelo) {
		  // Se obtiene el carro usando el método de la lógica de negocio
		try{
